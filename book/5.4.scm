; framed-stack discipline - not saving more registers than necessary (naively we could save all registers except val before each recursive call)
...
; define Scheme procedures to simulate the operations used as primitives by the evaluator
